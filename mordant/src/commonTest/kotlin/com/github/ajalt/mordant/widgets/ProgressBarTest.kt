...
class ProgressBarTest : RenderingTest() {
    ...
    @[Test JsName("pulse_100")]
    fun `pulse 100`() = doPulseTest(
        pulsePosition = 1f,
        "${CSI}38;2;97;175;239m━━━━━━━━━━${CSI}39m"
    )

    @[Test JsName("narrow_width")]
